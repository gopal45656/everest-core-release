...
#ifndef CAN_BUS_TO_EVSE_MANAGER_CAN_SIGNAL_RECEIVER_IMPL_HPP
#define CAN_BUS_TO_EVSE_MANAGER_CAN_SIGNAL_RECEIVER_IMPL_HPP
...
public:
    ...
    can_signal_receiverImpl(Everest::ModuleAdapter* ev,
                            const Everest::PtrContainer<CanBusToEvseManager>& mod,
                            Conf& config) :
...
#endif // CAN_BUS_TO_EVSE_MANAGER_CAN_SIGNAL_RECEIVER_IMPL_HPP
