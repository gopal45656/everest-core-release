.. _everest_modules_handwritten_SocketReceiver:

..  This file is a placeholder for optional multiple files
    handwritten documentation for the SocketReceiver module.
...
:ref:`Link <everest_modules_SocketReceiver>` to the module's reference.
Binary Signal Receiver via Unix Domain Socket
